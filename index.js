    ...
    async function askCredentials() {
        ...
        try {
            ...
            if (user) {
                ...
                spinnies.succeed('verifySpinner', {
                ...
                if (attempts >= maxAttempts) {
                    ...
                    spinnies.fail('verifySpinner', {
                        text: 'Too many failed attempts. Exiting...'
                    });
                    process.exit();
                }
                // Hentikan spinner dan tampilkan pesan percobaan gagal
                spinnies.fail('verifySpinner', {
                    text: `Invalid credentials. Attempts left: ${maxAttempts - attempts}`
                });
            ...
            spinnies.fail('verifySpinner', {
                text: 'Error during credential input'
            });
...
`,
    ...
    Raol404.sendText = (jid, text, quoted = '', options) => Raol404.sendMessage(jid, {
        text: text,
        ...options
    }, {
        quoted
    ...
    Raol404.sendFileUrl = async (jid, url, caption, quoted, options = {}) => {
        ...
        if (mime.split("/")[1] === "gif") {
            return Raol404.sendMessage(jid, {
    ...
    Raol404.sendPoll = (jid, name = '', values = [], selectableCount = 1) => {
        return Raol404.sendMessage(jid, {
            poll: {
                name,
                values,
    ...
    Raol404.sendImage = async (jid, path, caption = '', quoted = '', options) => {
        ...
        return await Raol404.sendMessage(jid, {
            image: buffer,
            caption: caption,
            ...options
        }, {
    ...
    Raol404.sendTextWithMentions = async (jid, text, quoted, options = {}) => Raol404.sendMessage(jid, {
        text: text,
    ...
    Raol404.copyNForward = async (jid, message, forceForward = false, options = {}) => {
        ...
        await Raol404.relayMessage(jid, waMessage.message, {
